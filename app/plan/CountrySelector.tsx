...
const STORAGE_KEY = "roadto100:visited-countries";
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex justify-center border-t border-zinc-100 pt-8">
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-full bg-zinc-900 px-8 py-3.5 text-base font-medium text-white shadow-sm transition-colors hover:bg-zinc-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900 disabled:cursor-not-allowed disabled:opacity-50"
          disabled={!hydrated || selected.size === 0}
        >
          Analyze My Journey
        </button>
      </div>
